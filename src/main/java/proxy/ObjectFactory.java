...
public class ObjectFactory {
    ...
    private static final QName _Convert_QNAME = new QName("http://example.org/", "Convert");
    private static final QName _ConvertResponse_QNAME = new QName("http://example.org/", "ConvertResponse");
    private static final QName _Compte_QNAME = new QName("http://example.org/", "compte");
